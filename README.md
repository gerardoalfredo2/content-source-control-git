...
Be sure to have your SSH key set up and that your pubvlic key(located in ~/
.ssh/id_rsa.pub) is added to your GItHUb account.
Be sure to have your SSH keyt setup and that your public key(located in .ssh/id_rsa.pub is added to your github account)
